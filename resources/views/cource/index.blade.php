                                    ...
                                    <div class="modal-body">
                                        <div class="row">
                                            ...
                                            <div class="col-xs-12 col-sm-12 col-md-12">
                                                <div class="form-group">
                                                    <strong>Time:</strong>
                                                    {!! Form::text('time', request()->get('time'), ['placeholder' => 'Time','maxlength'=> 100,'class' => 'form-control']) !!}
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-xs-12 col-sm-12 col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    {!! Form::text('during', request()->get('during'), ['placeholder' => 'During','maxlength'=> 100,'class' => 'form-control']) !!}
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-xs-12 col-sm-12 col-md-12">
                                                <div class="form-group">
                                                    <strong>Price:</strong>
                                                    {!! Form::text('price', request()->get('price'), ['placeholder' => 'Price','maxlength'=> 100,'class' => 'form-control']) !!}
                                                </div>
                                            </div>
