            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Create Cource</h3>
                    </div>
                    <div class="card-body">
                        {!! Form::open(['route' => 'cource.store','method'=>'POST']) !!}
                        <div class="row">
                            ...
                            <div class="col-xs-4 col-sm-4 col-md-4">
                                <div class="form-group">
                                    ...
                                    {!! Form::select('status', \App\Models\Cource::$statuses,null, ['autocomplete'=>'OFF','id'=>'status','required'=>true,'class' => "form-control ".($errors->has('status') ? 'is-invalid' : '')]) !!}
