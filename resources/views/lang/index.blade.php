            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Lang Management</h3>


                        @can('lang-create')
                            <a href="{{ route('lang.create') }}" class="btn btn-success btn-sm float-right">
                            ...
                            @foreach($langs as $lang)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group">
                                            @can('lang-show')
                                                <a class="" href="{{ route('lang.show',$lang->id) }}"
                                            ...
                                            @can('lang-edit')
                                                <a class="" href="{{ route('lang.edit',$lang->id) }}"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xs-12 col-sm-12 col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    {!! Form::select('status', \App\Models\Lang::$statuses,request()->get('status'), ['placeholder' => '','maxlength'=> 100,'class' => 'form-control']) !!}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
